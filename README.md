...
- [ANN Introduction](https://github.com/mfaria-p/Machine_learning_ANN.git) -> my introduction to machine learning, focusing on building and training Artificial Neural Networks using PyTorch
